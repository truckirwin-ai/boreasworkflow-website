...
// phone, platform, action) and routes the submission to sales@boreasworkflow.com via
...
const DEFAULT_INSTALLER_URL = 'https://downloads.boreasworkflow.com/boreas-latest-installer';
...
Ed25519-signed. The license Worker at license.boreasworkflow.com replaces this with
...
<p style="color:#666;font-size:12px;">The trial key above is a placeholder generated by /api/lead. It is not Ed25519-signed. The license Worker at license.boreasworkflow.com replaces this with a real signed key in a later build-order step.</p>
</body></html>`;
